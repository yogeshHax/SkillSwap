...
const SERVICE_TEMPLATES = [
  { title: 'Full-Stack Web Development Session',  category: 'technology', amount: 85,  description: 'One-on-one React/Node.js development session. Code review, architecture planning, debugging.' },
  ...
  { title: 'Guitar & Piano Lessons',              category: 'other',      amount: 70,  description: 'Music lessons for beginners to advanced players. Theory, technique, and practical playing.' },
...
async function seed() {
  ...
  const seedEmails = [...PROVIDERS, ...CUSTOMERS].map(u => u.email);
